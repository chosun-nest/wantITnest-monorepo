    ...
    return (
      ...
      <div className="flex justify-center items-center gap-10 mt-10">
        <a href={githubUrl} target="_blank" rel="noreferrer">
          <img src="/assets/images/github-mark.png" alt="GitHub" className="w-12 h-12 hover:opacity-80" />
        </a>
        <a href={linkedinUrl} target="_blank" rel="noreferrer">
          <img src="/assets/images/LinkedIn-logo.png" alt="LinkedIn" className="w-13 h-12 hover:opacity-80" />
        </a>
      </div>
