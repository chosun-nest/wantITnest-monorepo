    ...
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center pt-16 bg-black/40">
        <div className="w-full max-w-xl bg-white rounded-xl shadow-lg p-8 relative max-h-[70vh] flex flex-col">
          ...
          {/* 하단 고정 버튼 */}
          <div className="sticky bottom-0 left-0 flex justify-between pt-4 mt-6 bg-white border-t">
            <button
            ...
            <button
              className="w-full px-4 py-3 ml-2 rounded bg-[#002F6C] text-white hover:bg-[#001f4d]"
