...
public class PostTestDataLoader implements ApplicationRunner {
    ...
    private void createTestPosts() {
        ...
        // 게시글 데이터 배열
        Object[][] postData = {
            {1L, "Spring Boot 완전 정복하기", "Spring Boot를 이용한 웹 애플리케이션 개발의 모든 것을 알아보겠습니다. 프로젝트 구조부터 실제 배포까지 단계별로 설명하며, REST API 구현, JPA 활용, 보안 설정 등 실무에서 필요한 모든 기능을 다룹니다.", new String[]{"Spring Boot", "백엔드", "JAVA"}},
            {2L, "React Hook 완벽 가이드", "React Hook을 활용한 현대적인 React 개발 방법을 배워봅시다. useState, useEffect부터 커스텀 Hook 작성까지, 실제 프로젝트에서 활용할 수 있는 다양한 패턴과 베스트 프랙티스를 제공합니다.", new String[]{"React", "프론트엔드", "JavaScript"}},
            {2L, "Python으로 시작하는 머신러닝", "Python과 scikit-learn을 이용한 머신러닝 입문 가이드입니다. 데이터 전처리부터 모델 훈련, 평가까지 전체 머신러닝 파이프라인을 실습을 통해 학습할 수 있습니다.", new String[]{"Python", "머신러닝", "AI활용"}},
            {1L, "데이터베이스 설계 원칙", "효율적인 데이터베이스 설계를 위한 핵심 원칙들을 정리했습니다. 정규화, 인덱스 설계, 성능 최적화 등 실무에서 반드시 알아야 할 데이터베이스 설계 노하우를 공유합니다.", new String[]{"데이터베이스", "MySQL", "백엔드"}},
            {1L, "Unity로 만드는 2D 게임", "Unity를 이용한 2D 게임 개발 튜토리얼입니다. 캐릭터 움직임, 충돌 처리, UI 구현 등 기본적인 게임 시스템을 구축하면서 Unity의 핵심 기능들을 학습할 수 있습니다.", new String[]{"Unity", "게임 프로그래밍", "C#"}},
            {2L, "모던 CSS 레이아웃 기법", "Flexbox와 Grid를 활용한 현대적인 CSS 레이아웃 구현 방법을 알아봅시다. 반응형 웹 디자인부터 복잡한 레이아웃까지, 실무에서 활용할 수 있는 다양한 기법들을 예제와 함께 설명합니다.", new String[]{"CSS", "웹 퍼블리싱", "프론트엔드"}},
            {2L, "Docker 컨테이너 완벽 이해", "Docker를 이용한 컨테이너화 기술의 모든 것을 다룹니다. 이미지 빌드부터 Docker Compose, 쿠버네티스 연동까지 현대적인 DevOps 환경에서 필수적인 컨테이너 기술을 학습할 수 있습니다.", new String[]{"Docker", "데브옵스•인프라", "Kubernetes"}},
            ...
            {1L, "AWS 클라우드 아키텍처 설계", "AWS를 활용한 확장 가능한 클라우드 아키텍처 설계 방법론을 소개합니다. EC2, RDS, Lambda 등 주요 서비스들을 조합하여 실제 서비스 운영에 필요한 인프라를 구축하는 방법을 학습합니다.", new String[]{"AWS", "클라우드", "데브옵스•인프라"}},
            {2L, "UX/UI 디자인 가이드", "사용자 중심의 인터페이스 디자인 원칙과 실무 적용 방법을 다룹니다. 사용자 리서치부터 프로토타이핑, 사용성 테스트까지 전체 UX 프로세스를 실제 프로젝트 사례와 함께 설명합니다.", new String[]{"UX/UI", "Figma"}},
            {1L, "Flutter 모바일 앱 개발", "Flutter를 이용한 크로스 플랫폼 모바일 앱 개발 가이드입니다. Dart 언어 기초부터 상태 관리, 네이티브 기능 활용까지 실제 앱 출시에 필요한 모든 과정을 단계별로 설명합니다.", new String[]{"Flutter", "모바일 앱 개발"}},
            ...
            {2L, "데이터 시각화 마스터하기", "Python의 matplotlib, seaborn을 활용한 효과적인 데이터 시각화 방법을 학습합니다. 데이터의 특성에 따른 차트 선택부터 인터랙티브 시각화까지 다양한 기법들을 실습을 통해 익힐 수 있습니다.", new String[]{"Python", "데이터 분석"}},
            {2L, "블록체인과 스마트 컨트랙트", "블록체인 기술의 원리부터 이더리움 기반 스마트 컨트랙트 개발까지 다룹니다. Solidity 언어를 이용한 DApp 개발과 Web3 연동 방법을 실제 프로젝트를 통해 학습할 수 있습니다.", new String[]{"블록체인", "이더리움"}},
            {2L, "리눅스 시스템 관리 완벽 가이드", "리눅스 서버 관리에 필요한 모든 지식을 체계적으로 정리했습니다. 기본 명령어부터 서비스 관리, 보안 설정, 성능 튜닝까지 실무에서 바로 활용할 수 있는 실용적인 내용들을 다룹니다.", new String[]{"Linux", "시스템•운영체제"}}
        };
